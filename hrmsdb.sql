...
CREATE TABLE public.employees(
	...
	CONSTRAINT fk_employees FOREIGN KEY(id) REFERENCES public.users(id)
);
...
CREATE TABLE public.employers(
	...
	CONSTRAINT fk_employers FOREIGN KEY(id) REFERENCES public.users(id)
);
...
CREATE TABLE public.job_titles(
	...
	CONSTRAINT fk_jon_titles_title UNIQUE(title)
);